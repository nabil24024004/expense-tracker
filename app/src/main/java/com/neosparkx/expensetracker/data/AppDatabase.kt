...
@Database(entities = [Expense::class, DebtDue::class, Account::class, PlannedTransaction::class], version = 6, exportSchema = true)
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        val MIGRATION_5_6 = object : Migration(5, 6) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE `debts_dues` ADD COLUMN `accountId` INTEGER DEFAULT NULL")
            }
        }
